...
Opal.modules["asciidoctor-revealjs/converter"] = function(Opal) {
  ...
  Opal.add_stubs(['$==', '$require', '$nil?', '$option?', '$include?', '$join', '$map', '$split', '$!=', '$to_s', '$attr?', '$downcase', '$attr', '$inject', '$!', '$nil_or_empty?', '$is_a?', '$compact', '$<<', '$empty?', '$+', '$select', '$to_h', '$start_with?', '$data_attrs', '$role', '$roles', '$html_tag', '$merge', '$level', '$special', '$parent', '$instance_of?', '$object_id', '$[]', '$length', '$attributes', '$new', '$context', '$text', '$id', '$[]=', '$-', '$index', '$values', '$to_i', '$document', '$numbered', '$caption', '$<=', '$sectnum', '$captioned_title', '$instance_variable_get', '$converter', '$target', '$type', '$icon_uri', '$encode_attribute_value', '$alt', '$img_tag', '$img_link', '$has_role?', '$<', '$safe', '$read_svg_contents', '$html5_converter', '$image_uri', '$bool_data_attr', '$append_link_constraint_attrs', '$content', '$lambda', '$key?', '$fetch', '$delete', '$call', '$gsub', '$authors', '$format_author', '$first', '$each', '$in_context', '$sub_replacements', '$name', '$email', '$sub_macros', '$push', '$pop', '$generate', '$constants', '$const_set', '$const_get', '$register_for', '$respond_to?', '$basebackend', '$outfilesuffix', '$filetype', '$supports_templates', '$create', '$backend_info', '$node_name', '$send', '$extend', '$instance_eval', '$set_local_variables', '$binding', '$resolve_content', '$title?', '$title', '$===', '$flatten', '$map!', '$to_proc', '$reject!', '$list_marker_keyword', '$items', '$blocks?', '$media_uri', '$sections', '$section_level', '$section_title', '$convert', '$*', '$size', '$each_with_index', '$zero?', '$to_sym', '$strip', '$sub_specialcharacters', '$end_with?', '$notitle', '$has_header?', '$footnotes?', '$footnotes', '$content_for', '$noheader', '$docinfo', '$header?', '$reject', '$subtitle?', '$doctitle', '$slice_text', '$header', '$subtitle', '$find_by', '$generate_authors', '$extname', '$slice', '$normalize_web_path', '$generate_stem', '$syntax_highlighter', '$docinfo?', '$yield_content', '$to_boolean', '$to_valid_slidenumber', '$revealjs_dependencies', '$text?', '$chomp', '$last', '$style', '$colspan', '$rowspan', '$highlight?', '$format', '$tr_s', '$references', '$blocks', '$slide_footnotes', '$clear_slide_footnotes', '$>=', '$doctype', '$puts', '$slide_footnote', '$convert_image', '$convert_inline_image', '$inline_text_container', '$local_variable_set']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var $nesting = [self].concat($parent_nesting), $Converter$37, $Converter_initialize$38, $Converter_convert$39, $Converter_handles$ques$40, $Converter_ruler$41, $Converter_pass$43, $Converter_notes$45, $Converter_thematic_break$47, $Converter_olist$49, $Converter_inline_button$53, $Converter_audio$56, $Converter_quote$59, $Converter_admonition$62, $Converter_outline$65, $Converter_video$68, $Converter_verse$71, $Converter_inline_menu$74, $Converter_toc$80, $Converter_inline_kbd$82, $Converter_colist$87, $Converter_stretch_nested_elements$92, $Converter_stem$94, $Converter_literal$97, $Converter_embedded$100, $Converter_document$103, $Converter_sidebar$107, $Converter_inline_break$110, $Converter_inline_indexterm$112, $Converter_dlist$114, $Converter_ulist$125, $Converter_page_break$129, $Converter_table$131, $Converter_preamble$143, $Converter_listing$145, $Converter_inline_anchor$149, $Converter_section$153, $Converter_open$163, $Converter_inline_footnote$167, $Converter_image$171, $Converter_title_slide$174, $Converter_paragraph$176, $Converter_floating_title$179, $Converter_inline_callout$181, $Converter_inline_image$183, $Converter_inline_quoted$186, $Converter_example$188, $Converter_set_local_variables$191;
    ...
    (function($base, $parent_nesting) {
      ...
      var $nesting = [self].concat($parent_nesting), $Helpers_slice_text$1, $Helpers_to_boolean$3, $Helpers_bool_data_attr$4, $Helpers_to_valid_slidenumber$5, $Helpers_html_tag$6, $Helpers_data_attrs$8, $Helpers_inline_text_container$11, $Helpers_section_level$12, $Helpers_slide_footnote$13, $Helpers_clear_slide_footnotes$14, $Helpers_slide_footnotes$15, $Helpers_section_title$16, $Helpers_html5_converter$17, $Helpers_convert_inline_image$18, $Helpers_convert_image$19, $Helpers_img_tag$20, $Helpers_img_link$21, $Helpers_revealjs_dependencies$22, $Helpers_resolve_content$23, $Helpers_content_for$24, $Helpers_content_for$ques$26, $Helpers_yield_content$27, $Helpers_append_link_constraint_attrs$29, $Helpers_encode_attribute_value$30, $Helpers_generate_authors$31, $Helpers_format_author$33, $Helpers_in_context$35, $Helpers_generate_stem$36;
      ...
      Opal.def(self, '$html5_converter', $Helpers_html5_converter$17 = function $$html5_converter() {
        var self = this;

        return self.$converter().$instance_variable_get("@delegate_converter")
      }, $Helpers_html5_converter$17.$$arity = 0);
      
      Opal.def(self, '$convert_inline_image', $Helpers_convert_inline_image$18 = function $$convert_inline_image(node) {
        var $a, $b, self = this, target = nil, icons = nil, i_class_attr_val = nil, attrs = nil, img = nil, src = nil, html_attrs = nil;
        ...
        target = node.$target();
        if (($truthy($a = node.$type()) ? $a : "image")['$==']("icon")) {
          ...
          html_attrs = (function() {if ($truthy(node['$attr?']("width"))) {
            return "" + " width=\"" + (node.$attr("width")) + "\""
          } else {
            return ""
          }; return nil; })();
          ...
          $b = self.$img_tag(node, target, html_attrs), $a = Opal.to_ary($b), (img = ($a[0] == null ? nil : $a[0])), (src = ($a[1] == null ? nil : $a[1])), $b;
        };
        return self.$img_link(node, src, img);
      }, $Helpers_convert_inline_image$18.$$arity = -1);
      
      Opal.def(self, '$convert_image', $Helpers_convert_image$19 = function $$convert_image(node) {
        var $a, $b, self = this, height_value = nil, html_attrs = nil, img = nil, src = nil;
        ...
        if ($truthy(($truthy($a = node['$has_role?']("stretch")) ? ($truthy($b = node['$attr?']("width")) ? $b : node['$attr?']("height"))['$!']() : $a))) {
          height_value = "100%"
        ...
        $b = self.$img_tag(node, node.$attr("target"), html_attrs), $a = Opal.to_ary($b), (img = ($a[0] == null ? nil : $a[0])), (src = ($a[1] == null ? nil : $a[1])), $b;
        return self.$img_link(node, src, img);
      }, $Helpers_convert_image$19.$$arity = -1);
      
      Opal.def(self, '$img_tag', $Helpers_img_tag$20 = function $$img_tag($a, $b, $c) {
        var $post_args, node, target, html_attrs, $d, $e, self = this, img = nil, fallback = nil, src = nil;

        
        
        $post_args = Opal.slice.call(arguments, 0, arguments.length);
        
        if ($post_args.length > 2) {
          node = $post_args[0];
        ...
        html_attrs = $post_args[0];
        $post_args.splice(0, 1);
        if (html_attrs == null) {
          html_attrs = nil
        };
        if ($truthy(($truthy($d = ($truthy($e = node['$attr?']("format", "svg")) ? $e : target['$include?'](".svg"))) ? $rb_lt(node.$document().$safe(), $$$($$$($$$('::', 'Asciidoctor'), 'SafeMode'), 'SECURE')) : $d))) {
          if ($truthy(node['$option?']("inline"))) {
            img = ($truthy($d = self.$html5_converter().$read_svg_contents(node, target)) ? $d : "" + "<span class=\"alt\">" + (node.$alt()) + "</span>")
          } else if ($truthy(node['$option?']("interactive"))) {
            
            fallback = (function() {if ($truthy(node['$attr?']("fallback"))) {
              return "" + "<img src=\"" + (node.$image_uri(node.$attr("fallback"))) + "\" alt=\"" + (self.$encode_attribute_value(node.$alt())) + "\"" + (html_attrs) + ">"
            } else {
        ...
        return [img, src];
      }, $Helpers_img_tag$20.$$arity = -3);
      
      Opal.def(self, '$img_link', $Helpers_img_link$21 = function $$img_link($a, $b, $c) {
        var $post_args, node, src, content, $d, $e, self = this, href_attr_val = nil, link_preview_value = nil, data_preview_attr = nil;
        ...
        if ($truthy(($truthy($d = node['$attr?']("link")) ? ($truthy($e = (href_attr_val = node.$attr("link"))['$!=']("self")) ? $e : (href_attr_val = src)) : $d))) {
          
          if ($truthy((link_preview_value = self.$bool_data_attr("link_preview")))) {
            data_preview_attr = "" + " data-preview-link=\"" + ((function() {if (link_preview_value['$=='](true)) {
              return ""
            } else {
              return link_preview_value
            }; return nil; })()) + "\""};
          return "" + "<a class=\"image\" href=\"" + (href_attr_val) + "\"" + (self.$append_link_constraint_attrs(node).$join()) + (data_preview_attr) + ">" + (content) + "</a>";};
        return content;
      }, $Helpers_img_link$21.$$arity = -3);
      
      Opal.def(self, '$revealjs_dependencies', $Helpers_revealjs_dependencies$22 = function $$revealjs_dependencies(document, node, revealjsdir) {
      ...
      }, $Helpers_revealjs_dependencies$22.$$arity = 3);
      
      Opal.def(self, '$resolve_content', $Helpers_resolve_content$23 = function $$resolve_content() {
        var self = this;
      ...
      }, $Helpers_resolve_content$23.$$arity = 0);
      
      Opal.def(self, '$content_for', $Helpers_content_for$24 = function $$content_for(key, opts) {
        var $iter = $Helpers_content_for$24.$$p, block = $iter || nil, $a, $b, $$25, self = this, $writer = nil;
        if (self.content == null) self.content = nil;

        if ($iter) $Helpers_content_for$24.$$p = null;
        ...
        (function() {if ($truthy(opts['$[]']("append"))) {
          ...
          return $send(self, 'lambda', [], ($$25 = function(){var self = $$25.$$s || this;

          return opts['$[]']("content")}, $$25.$$s = self, $$25.$$arity = 0, $$25))
        }; return nil; })());
        return nil;
      }, $Helpers_content_for$24.$$arity = -2);
      
      Opal.def(self, '$content_for?', $Helpers_content_for$ques$26 = function(key) {
        var $a, $b, self = this;
        if (self.content == null) self.content = nil;

        return ($truthy($a = (($b = self['content'], $b != null && $b !== nil) ? 'instance-variable' : nil)) ? self.content['$key?'](key) : $a)
      }, $Helpers_content_for$ques$26.$$arity = 1);
      
      Opal.def(self, '$yield_content', $Helpers_yield_content$27 = function $$yield_content(key, opts) {
        var $a, $b, $$28, self = this, blks = nil;
        if (self.content == null) self.content = nil;
        ...
        if ($truthy(($truthy($a = (($b = self['content'], $b != null && $b !== nil) ? 'instance-variable' : nil)) ? (blks = (function() {if ($truthy(opts.$fetch("drain", true))) {
          ...
          $send(blks, 'map', [], ($$28 = function(b){var self = $$28.$$s || this;
            ...
            return b.$call();}, $$28.$$s = self, $$28.$$arity = 1, $$28)).$join()};
        return nil;
      }, $Helpers_yield_content$27.$$arity = -2);
      
      Opal.def(self, '$append_link_constraint_attrs', $Helpers_append_link_constraint_attrs$29 = function $$append_link_constraint_attrs(node, attrs) {
        ...
        if ($truthy((window = node.$attributes()['$[]']("window")))) {
          ...
          attrs['$<<']("" + " rel=\"" + (rel) + "\"")};
        return attrs;
      }, $Helpers_append_link_constraint_attrs$29.$$arity = -2);
      
      Opal.def(self, '$encode_attribute_value', $Helpers_encode_attribute_value$30 = function $$encode_attribute_value(val) {
        var self = this;
      ...
      }, $Helpers_encode_attribute_value$30.$$arity = 1);
      
      Opal.def(self, '$generate_authors', $Helpers_generate_authors$31 = function $$generate_authors(node) {
        ...
        if (node.$authors().$length()['$=='](1)) {
          ...
          $send(node.$authors(), 'each', [], ($$32 = function(author){var self = $$32.$$s || this;
            ...
            return result['$<<']("" + "<li>" + (self.$format_author(node, author)) + "</li>");}, $$32.$$s = self, $$32.$$arity = 1, $$32));
          result['$<<']("</ul>");
          return result.$join($$$($$($nesting, 'Asciidoctor'), 'LF'));
        };
      }, $Helpers_generate_authors$31.$$arity = 1);
      
      Opal.def(self, '$format_author', $Helpers_format_author$33 = function $$format_author(node, author) {
        var $$34, self = this;

        return $send(self, 'in_context', ["author"], ($$34 = function(){var self = $$34.$$s || this;
        ...
        return "" + "<span class=\"author\">" + (node.$sub_replacements(author.$name())) + ((function() {if ($truthy(author.$email())) {
            ...
            return ""
          }; return nil; })()) + "</span>"}, $$34.$$s = self, $$34.$$arity = 0, $$34))
      }, $Helpers_format_author$33.$$arity = 2);
      
      Opal.def(self, '$in_context', $Helpers_in_context$35 = function $$in_context(name) {
        var $a, $iter = $Helpers_in_context$35.$$p, $yield = $iter || nil, self = this, result = nil;
        if (self.convert_context == null) self.convert_context = nil;

        if ($iter) $Helpers_in_context$35.$$p = null;
        
        (self.convert_context = ($truthy($a = self.convert_context) ? $a : [])).$push(name);
        result = Opal.yieldX($yield, []);
        self.convert_context.$pop();
        return result;
      }, $Helpers_in_context$35.$$arity = 1);
      ...
      Opal.def(self, '$generate_stem', $Helpers_generate_stem$36 = function $$generate_stem(cdn_base) {
      ...
      }, $Helpers_generate_stem$36.$$arity = 1);
    })($nesting[0], $nesting);
    $send($$($nesting, 'Helpers').$constants(), 'each', [], ($Converter$37 = function(const$){var self = $Converter$37.$$s || this;
      ...
      return self.$const_set(const$, $$($nesting, 'Helpers').$const_get(const$));}, $Converter$37.$$s = self, $Converter$37.$$arity = 1, $Converter$37));
    self.$register_for("revealjs", "reveal.js");
    
    Opal.def(self, '$initialize', $Converter_initialize$38 = function $$initialize(backend, opts) {
      var $a, $iter = $Converter_initialize$38.$$p, $yield = $iter || nil, self = this, delegate_backend = nil, factory = nil, converter = nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) $Converter_initialize$38.$$p = null;
      ...
      $send(self, Opal.find_super_dispatcher(self, 'initialize', $Converter_initialize$38, false), $zuper, $iter);
    ...
    }, $Converter_initialize$38.$$arity = -2);
    
    Opal.def(self, '$convert', $Converter_convert$39 = function $$convert(node, transform, opts) {
    ...
    }, $Converter_convert$39.$$arity = -2);
    
    Opal.def(self, '$handles?', $Converter_handles$ques$40 = function(transform) {
      var $a, self = this;

      return ($truthy($a = self['$respond_to?']("" + "convert_" + (transform))) ? $a : self['$respond_to?'](transform))
    }, $Converter_handles$ques$40.$$arity = 1);
    
    Opal.def(self, '$ruler', $Converter_ruler$41 = function $$ruler(node, opts) {
      var $$42, self = this;
    ...
    }, $Converter_ruler$41.$$arity = -2);
    
    Opal.def(self, '$pass', $Converter_pass$43 = function $$pass(node, opts) {
      var $$44, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$44 = function(){var self = $$44.$$s || this, _buf = nil;
    ...
    }, $Converter_pass$43.$$arity = -2);
    
    Opal.def(self, '$notes', $Converter_notes$45 = function $$notes(node, opts) {
      var $$46, self = this;
    ...
    }, $Converter_notes$45.$$arity = -2);
    
    Opal.def(self, '$thematic_break', $Converter_thematic_break$47 = function $$thematic_break(node, opts) {
      var $$48, self = this;
    ...
    }, $Converter_thematic_break$47.$$arity = -2);
    
    Opal.def(self, '$olist', $Converter_olist$49 = function $$olist(node, opts) {
      var $$50, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$50 = function(){var self = $$50.$$s || this, $$51, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        ...
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["olist", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], ($$51 = function(){var self = $$51.$$s || this, $$52, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil;
          if (self.style == null) self.style = nil;
          ...
          _slim_controls2['$<<'](">");
          $send(self.$items(), 'each', [], ($$52 = function(item){var self = $$52.$$s || this, $a, $b, _temple_html_attributeremover2 = nil, _slim_codeattributes4 = nil;
            ...
            return _slim_controls2['$<<']("</li>");}, $$52.$$s = self, $$52.$$arity = 1, $$52));
          _slim_controls2['$<<']("</ol>");
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$51.$$s = self, $$51.$$arity = 0, $$51));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$50.$$s = self, $$50.$$arity = 0, $$50));
    }, $Converter_olist$49.$$arity = -2);
    
    Opal.def(self, '$inline_button', $Converter_inline_button$53 = function $$inline_button(node, opts) {
      var $$54, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$54 = function(){var self = $$54.$$s || this, $$55, _buf = nil, _slim_controls1 = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["b", $hash2(["class"], {"class": ["button"]}).$merge(self.$data_attrs(self.attributes))], ($$55 = function(){var self = $$55.$$s || this, _slim_controls2 = nil;
          if (self.text == null) self.text = nil;

        
          _slim_controls2 = [];
          _slim_controls2['$<<'](self.text);
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$55.$$s = self, $$55.$$arity = 0, $$55));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$54.$$s = self, $$54.$$arity = 0, $$54));
    }, $Converter_inline_button$53.$$arity = -2);
    
    Opal.def(self, '$audio', $Converter_audio$56 = function $$audio(node, opts) {
      var $$57, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$57 = function(){var self = $$57.$$s || this, $$58, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _buf = [];
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["audioblock", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], ($$58 = function(){var self = $$58.$$s || this, _slim_controls2 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil;
          ...
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$58.$$s = self, $$58.$$arity = 0, $$58));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$57.$$s = self, $$57.$$arity = 0, $$57));
    }, $Converter_audio$56.$$arity = -2);
    
    Opal.def(self, '$quote', $Converter_quote$59 = function $$quote(node, opts) {
      var $$60, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$60 = function(){var self = $$60.$$s || this, $a, $$61, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["quoteblock", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$61 = function(){var self = $$61.$$s || this, $b, _slim_controls2 = nil, attribution = nil, citetitle = nil;
          ...
          if ($truthy(($truthy($b = attribution) ? $b : citetitle))) {
            ...
            _slim_controls2['$<<']("</div>");};
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$61.$$s = self, $$61.$$arity = 0, $$61));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$60.$$s = self, $$60.$$arity = 0, $$60));
    }, $Converter_quote$59.$$arity = -2);
    
    Opal.def(self, '$admonition', $Converter_admonition$62 = function $$admonition(node, opts) {
      var $$63, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$63 = function(){var self = $$63.$$s || this, $a, $b, $$64, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if ($truthy(($truthy($a = ($truthy($b = self['$has_role?']("aside")) ? $b : self['$has_role?']("speaker"))) ? $a : self['$has_role?']("notes")))) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["admonitionblock", self.$attr("name"), self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
            ...
            return nil
          }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$64 = function(){var self = $$64.$$s || this, $c, _slim_controls2 = nil, icon_mapping = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil;
            ...
            return (_slim_controls2 = _slim_controls2.$join(""));}, $$64.$$s = self, $$64.$$arity = 0, $$64));
          _buf['$<<'](_slim_controls1);
        };
        return (_buf = _buf.$join(""));}, $$63.$$s = self, $$63.$$arity = 0, $$63));
    }, $Converter_admonition$62.$$arity = -2);
    
    Opal.def(self, '$outline', $Converter_outline$65 = function $$outline(node, opts) {
      var $$66, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$66 = function(){var self = $$66.$$s || this, $a, $$67, _buf = nil, toclevels = nil, slevel = nil;
        ...
        if ($truthy(self.$sections()['$empty?']())) {
          ...
          _buf['$<<'](slevel);
          _buf['$<<']("\">");
          $send(self.$sections(), 'each', [], ($$67 = function(sec){var self = $$67.$$s || this, $b, child_toc = nil;
            ...
            if ($truthy(($truthy($b = $rb_lt(sec.$level(), toclevels)) ? (child_toc = self.$converter().$convert(sec, "outline")) : $b))) {
              _buf['$<<'](child_toc)};
            return _buf['$<<']("</li>");}, $$67.$$s = self, $$67.$$arity = 1, $$67));
          _buf['$<<']("</ol>");
        };
        return (_buf = _buf.$join(""));}, $$66.$$s = self, $$66.$$arity = 0, $$66));
    }, $Converter_outline$65.$$arity = -2);
    
    Opal.def(self, '$video', $Converter_video$68 = function $$video(node, opts) {
      var $$69, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$69 = function(){var self = $$69.$$s || this, $a, $b, $$70, _buf = nil, no_stretch = nil, width = nil, height = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["videoblock", self.style, self.$role(), (function() {if ($truthy(no_stretch)) {
          ...
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$70.$$s = self, $$70.$$arity = 0, $$70));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$69.$$s = self, $$69.$$arity = 0, $$69));
    }, $Converter_video$68.$$arity = -2);
    
    Opal.def(self, '$verse', $Converter_verse$71 = function $$verse(node, opts) {
      var $$72, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$72 = function(){var self = $$72.$$s || this, $a, $$73, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["verseblock", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$73 = function(){var self = $$73.$$s || this, $b, _slim_controls2 = nil, attribution = nil, citetitle = nil;
          ...
          if ($truthy(($truthy($b = attribution) ? $b : citetitle))) {
            ...
            if ($truthy(attribution)) {
              ...
              _slim_controls2['$<<'](attribution);};
            _slim_controls2['$<<']("</div>");};
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$73.$$s = self, $$73.$$arity = 0, $$73));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$72.$$s = self, $$72.$$arity = 0, $$72));
    }, $Converter_verse$71.$$arity = -2);
    
    Opal.def(self, '$inline_menu', $Converter_inline_menu$74 = function $$inline_menu(node, opts) {
      var $$75, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$75 = function(){var self = $$75.$$s || this, $$76, $$78, $$79, _buf = nil, menu = nil, menuitem = nil, submenus = nil, _slim_controls1 = nil, _slim_controls3 = nil, _slim_controls5 = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if ($truthy((submenus = self.$attr("submenus"))['$empty?']()['$!']())) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["menuseq"]}).$merge(self.$data_attrs(self.attributes))], ($$76 = function(){var self = $$76.$$s || this, $$77, _slim_controls2 = nil;
            ...
            _slim_controls2['$<<']($send(submenus, 'map', [], ($$77 = function(submenu){var self = $$77.$$s || this;
              ...
              return "" + "<span class=\"submenu\">" + (submenu) + "</span>&#160;&#9656;&#32;";}, $$77.$$s = self, $$77.$$arity = 1, $$77)).$join());
            _slim_controls2['$<<']("<span class=\"menuitem\">");
            _slim_controls2['$<<'](menuitem);
            _slim_controls2['$<<']("</span>");
            return (_slim_controls2 = _slim_controls2.$join(""));}, $$76.$$s = self, $$76.$$arity = 0, $$76));
          _buf['$<<'](_slim_controls1);
        } else if ($truthy(menuitem['$nil?']()['$!']())) {
          
          _slim_controls3 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["menuseq"]}).$merge(self.$data_attrs(self.attributes))], ($$78 = function(){var self = $$78.$$s || this, _slim_controls4 = nil;
            ...
            return (_slim_controls4 = _slim_controls4.$join(""));}, $$78.$$s = self, $$78.$$arity = 0, $$78));
          _buf['$<<'](_slim_controls3);
        } else {
          
          _slim_controls5 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["menu"]}).$merge(self.$data_attrs(self.attributes))], ($$79 = function(){var self = $$79.$$s || this, _slim_controls6 = nil;

          
            _slim_controls6 = [];
            _slim_controls6['$<<'](menu);
            return (_slim_controls6 = _slim_controls6.$join(""));}, $$79.$$s = self, $$79.$$arity = 0, $$79));
          _buf['$<<'](_slim_controls5);
        };
        return (_buf = _buf.$join(""));}, $$75.$$s = self, $$75.$$arity = 0, $$75));
    }, $Converter_inline_menu$74.$$arity = -2);
    
    Opal.def(self, '$toc', $Converter_toc$80 = function $$toc(node, opts) {
      var $$81, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$81 = function(){var self = $$81.$$s || this, _buf = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil;
        ...
        _buf['$<<']("</div>");
        return (_buf = _buf.$join(""));}, $$81.$$s = self, $$81.$$arity = 0, $$81));
    }, $Converter_toc$80.$$arity = -2);
    
    Opal.def(self, '$inline_kbd', $Converter_inline_kbd$82 = function $$inline_kbd(node, opts) {
      var $$83, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$83 = function(){var self = $$83.$$s || this, $$84, $$85, _buf = nil, keys = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if ((keys = self.$attr("keys")).$size()['$=='](1)) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["kbd", self.$data_attrs(self.attributes)], ($$84 = function(){var self = $$84.$$s || this, _slim_controls2 = nil;

          
            _slim_controls2 = [];
            _slim_controls2['$<<'](keys.$first());
            return (_slim_controls2 = _slim_controls2.$join(""));}, $$84.$$s = self, $$84.$$arity = 0, $$84));
          _buf['$<<'](_slim_controls1);
        } else {
          
          _slim_controls3 = $send(self, 'html_tag', ["span", $hash2(["class"], {"class": ["keyseq"]}).$merge(self.$data_attrs(self.attributes))], ($$85 = function(){var self = $$85.$$s || this, $$86, _slim_controls4 = nil;

          
            _slim_controls4 = [];
            $send(keys, 'each_with_index', [], ($$86 = function(key, idx){var self = $$86.$$s || this;
              ...
              _slim_controls4['$<<']("<kbd>");
              _slim_controls4['$<<'](key);
              return _slim_controls4['$<<']("</kbd>");}, $$86.$$s = self, $$86.$$arity = 2, $$86));
            return (_slim_controls4 = _slim_controls4.$join(""));}, $$85.$$s = self, $$85.$$arity = 0, $$85));
          _buf['$<<'](_slim_controls3);
        };
        return (_buf = _buf.$join(""));}, $$83.$$s = self, $$83.$$arity = 0, $$83));
    }, $Converter_inline_kbd$82.$$arity = -2);
    
    Opal.def(self, '$colist', $Converter_colist$87 = function $$colist(node, opts) {
      var $$88, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$88 = function(){var self = $$88.$$s || this, $a, $$89, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["colist", self.style, self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$89 = function(){var self = $$89.$$s || this, $$90, $$91, _slim_controls2 = nil, font_icons = nil;
          if (self.document == null) self.document = nil;
          ...
          if ($truthy(self.document['$attr?']("icons"))) {
            ...
            $send(self.$items(), 'each_with_index', [], ($$90 = function(item, i){var self = $$90.$$s || this, num = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil;
              ...
              _slim_controls2['$<<'](item.$text());
              return _slim_controls2['$<<']("</td></tr>");}, $$90.$$s = self, $$90.$$arity = 2, $$90));
            _slim_controls2['$<<']("</table>");
          } else {
            ...
            $send(self.$items(), 'each', [], ($$91 = function(item){var self = $$91.$$s || this;
              ...
              _slim_controls2['$<<'](item.$text());
              return _slim_controls2['$<<']("</p></li>");}, $$91.$$s = self, $$91.$$arity = 1, $$91));
            _slim_controls2['$<<']("</ol>");
          };
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$89.$$s = self, $$89.$$arity = 0, $$89));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$88.$$s = self, $$88.$$arity = 0, $$88));
    }, $Converter_colist$87.$$arity = -2);
    
    Opal.def(self, '$stretch_nested_elements', $Converter_stretch_nested_elements$92 = function $$stretch_nested_elements(node, opts) {
      var $$93, self = this;
    ...
    }, $Converter_stretch_nested_elements$92.$$arity = -2);
    
    Opal.def(self, '$stem', $Converter_stem$94 = function $$stem(node, opts) {
      var $$95, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$95 = function(){var self = $$95.$$s || this, $a, $b, $$96, _buf = nil, open = nil, close = nil, equation = nil, _slim_controls1 = nil;
        if (self.style == null) self.style = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["stemblock", self.$role(), (function() {if ($truthy(($truthy($a = ($truthy($b = self['$option?']("step")) ? $b : self['$has_role?']("step"))) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$96 = function(){var self = $$96.$$s || this, _slim_controls2 = nil;
          ...
          _slim_controls2['$<<']("</div>");
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$96.$$s = self, $$96.$$arity = 0, $$96));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$95.$$s = self, $$95.$$arity = 0, $$95));
    }, $Converter_stem$94.$$arity = -2);
    
    Opal.def(self, '$literal', $Converter_literal$97 = function $$literal(node, opts) {
      var $$98, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$98 = function(){var self = $$98.$$s || this, $a, $$99, _buf = nil, _slim_controls1 = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.$id(), "class": ["literalblock", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$99 = function(){var self = $$99.$$s || this, $b, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil;
          if (self.document == null) self.document = nil;
          ...
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$99.$$s = self, $$99.$$arity = 0, $$99));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$98.$$s = self, $$98.$$arity = 0, $$98));
    }, $Converter_literal$97.$$arity = -2);
    
    Opal.def(self, '$embedded', $Converter_embedded$100 = function $$embedded(node, opts) {
      var $$101, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$101 = function(){var self = $$101.$$s || this, $a, $$102, _buf = nil, _slim_codeattributes1 = nil;
        if (self.id == null) self.id = nil;
        ...
        if ($truthy(($truthy($a = self['$footnotes?']()['$!']()) ? $a : self['$attr?']("nofootnotes")))) {
          ...
          $send(self.$footnotes(), 'each', [], ($$102 = function(fn){var self = $$102.$$s || this;
            ...
            _buf['$<<']("</a>. ");
            _buf['$<<'](fn.$text());
            return _buf['$<<']("</div>");}, $$102.$$s = self, $$102.$$arity = 1, $$102));
          _buf['$<<']("</div>");
        };
        return (_buf = _buf.$join(""));}, $$101.$$s = self, $$101.$$arity = 0, $$101));
    }, $Converter_embedded$100.$$arity = -2);
    
    Opal.def(self, '$document', $Converter_document$103 = function $$document(node, opts) {
      var $$104, self = this;
      ...
      return $send(node, 'instance_eval', [], ($$104 = function(){var self = $$104.$$s || this, $$105, $a, $$106, _buf = nil, slides_content = nil, _slim_codeattributes16 = nil, revealjsdir = nil, asset_uri_scheme = nil, cdn_base = nil, icon_href = nil, icon_type = nil, icon_ext = nil, linkcss = nil, _slim_codeattributes19 = nil, iconfont_cdn = nil, _slim_codeattributes20 = nil, font_awesome_version = nil, _slim_codeattributes21 = nil, _slim_codeattributes22 = nil, _slim_codeattributes23 = nil, syntax_hl = nil, _slim_codeattributes24 = nil, customcss = nil, _docinfo = nil, docinfo_content = nil;
        ...
        $send(self, 'content_for', ["slides"], ($$105 = function(){var self = $$105.$$s || this, $a, header_docinfo = nil, bg_image = nil, bg_video = nil, _temple_html_attributeremover1 = nil, _temple_html_attributemerger1 = nil, $writer = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil, _slim_codeattributes5 = nil, _slim_codeattributes6 = nil, _slim_codeattributes7 = nil, _slim_codeattributes8 = nil, _slim_codeattributes9 = nil, _slim_codeattributes10 = nil, _slim_codeattributes11 = nil, _slim_codeattributes12 = nil, _slim_codeattributes13 = nil, _slim_codeattributes14 = nil, _slim_codeattributes15 = nil, _title_obj = nil, _slice = nil, preamble = nil, footer_docinfo = nil;
          if (self.header == null) self.header = nil;
          if (self.document == null) self.document = nil;
        ...
        $send(["description", "keywords", "author", "copyright"], 'each', [], ($$106 = function(key){var self = $$106.$$s || this, _slim_codeattributes17 = nil, _slim_codeattributes18 = nil;
    ...
    }, $Converter_document$103.$$arity = -2);
    
    Opal.def(self, '$sidebar', $Converter_sidebar$107 = function $$sidebar(node, opts) {
      var $$108, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$108 = function(){var self = $$108.$$s || this, $a, $b, $$109, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if ($truthy(($truthy($a = ($truthy($b = self['$has_role?']("aside")) ? $b : self['$has_role?']("speaker"))) ? $a : self['$has_role?']("notes")))) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["sidebarblock", self.$role(), (function() {if ($truthy(($truthy($a = ($truthy($b = self['$option?']("step")) ? $b : self['$has_role?']("step"))) ? $a : self['$attr?']("step")))) {
            ...
            return nil
          }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$109 = function(){var self = $$109.$$s || this, _slim_controls2 = nil;
    ...
    }, $Converter_sidebar$107.$$arity = -2);
    
    Opal.def(self, '$inline_break', $Converter_inline_break$110 = function $$inline_break(node, opts) {
      var $$111, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$111 = function(){var self = $$111.$$s || this, _buf = nil;
        if (self.text == null) self.text = nil;
    ...
    }, $Converter_inline_break$110.$$arity = -2);
    
    Opal.def(self, '$inline_indexterm', $Converter_inline_indexterm$112 = function $$inline_indexterm(node, opts) {
      var $$113, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$113 = function(){var self = $$113.$$s || this, _buf = nil;
    ...
    }, $Converter_inline_indexterm$112.$$arity = -2);
    
    Opal.def(self, '$dlist', $Converter_dlist$114 = function $$dlist(node, opts) {
      var $$115, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$115 = function(){var self = $$115.$$s || this, $$116, $$119, $$122, _buf = nil, $case = nil, _slim_controls1 = nil, _slim_controls3 = nil, _slim_controls5 = nil;
        if (self.style == null) self.style = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        $case = self.style;
        if ("qanda"['$===']($case)) {
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["qlist", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], ($$116 = function(){var self = $$116.$$s || this, $$117, _slim_controls2 = nil;
          ...
          if ($truthy(self['$title?']())) {
            ...
            _slim_controls2['$<<']("</div>");};
          _slim_controls2['$<<']("<ol>");
          $send(self.$items(), 'each', [], ($$117 = function(questions, answer){var self = $$117.$$s || this, $$118;
            ...
            _slim_controls2['$<<']("<li>");
            $send([].concat(Opal.to_a(questions)), 'each', [], ($$118 = function(question){var self = $$118.$$s || this;
              ...
              return _slim_controls2['$<<']("</em></p>");}, $$118.$$s = self, $$118.$$arity = 1, $$118));
            ...
            return _slim_controls2['$<<']("</li>");}, $$117.$$s = self, $$117.$$arity = 2, $$117));
          _slim_controls2['$<<']("</ol>");
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$116.$$s = self, $$116.$$arity = 0, $$116));
        _buf['$<<'](_slim_controls1);}
        else if ("horizontal"['$===']($case)) {
        _slim_controls3 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["hdlist", self.$role()]}).$merge(self.$data_attrs(self.attributes))], ($$119 = function(){var self = $$119.$$s || this, $a, $$120, _slim_controls4 = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil;
          ...
          $send(self.$items(), 'each', [], ($$120 = function(terms, dd){var self = $$120.$$s || this, $$121, _temple_html_attributeremover1 = nil, _slim_codeattributes3 = nil, last_term = nil;
            ...
            $send(terms, 'each', [], ($$121 = function(dt){var self = $$121.$$s || this;
            ...
            return _slim_controls4['$<<']("</td></tr>");}, $$120.$$s = self, $$120.$$arity = 2, $$120));
          _slim_controls4['$<<']("</table>");
          return (_slim_controls4 = _slim_controls4.$join(""));}, $$119.$$s = self, $$119.$$arity = 0, $$119));
        _buf['$<<'](_slim_controls3);}
        else {
        _slim_controls5 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["dlist", self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], ($$122 = function(){var self = $$122.$$s || this, $$123, _slim_controls6 = nil;
          ...
          if ($truthy(self['$title?']())) {
            ...
            _slim_controls6['$<<']("</div>");};
          _slim_controls6['$<<']("<dl>");
          $send(self.$items(), 'each', [], ($$123 = function(terms, dd){var self = $$123.$$s || this, $$124;
            ...
            $send([].concat(Opal.to_a(terms)), 'each', [], ($$124 = function(dt){var self = $$124.$$s || this, _temple_html_attributeremover2 = nil, _slim_codeattributes4 = nil;
              if (self.style == null) self.style = nil;
              ...
              return _slim_controls6['$<<']("</dt>");}, $$124.$$s = self, $$124.$$arity = 1, $$124));
            if ($truthy(dd['$nil?']())) {
              return nil
            } else {
          ...
          _slim_controls6['$<<']("</dl>");
          return (_slim_controls6 = _slim_controls6.$join(""));}, $$122.$$s = self, $$122.$$arity = 0, $$122));
        _buf['$<<'](_slim_controls5);};
        return (_buf = _buf.$join(""));}, $$115.$$s = self, $$115.$$arity = 0, $$115));
    }, $Converter_dlist$114.$$arity = -2);
    
    Opal.def(self, '$ulist', $Converter_ulist$125 = function $$ulist(node, opts) {
      var $$126, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$126 = function(){var self = $$126.$$s || this, $$127, _buf = nil, checklist = nil, marker_checked = nil, marker_unchecked = nil, _slim_controls1 = nil;
        if (self.document == null) self.document = nil;
        if (self.id == null) self.id = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["ulist", checklist, self.style, self.$role()]}).$merge(self.$data_attrs(self.attributes))], ($$127 = function(){var self = $$127.$$s || this, $a, $$128, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil;
          if (self.style == null) self.style = nil;
          ...
          if ($truthy(_temple_html_attributeremover1['$empty?']()['$!']())) {
            ...
            _slim_controls2['$<<']("\"");};
          _slim_controls2['$<<'](">");
          $send(self.$items(), 'each', [], ($$128 = function(item){var self = $$128.$$s || this, $b, $c, _temple_html_attributeremover2 = nil, _slim_codeattributes2 = nil;
            ...
            if ($truthy(item['$blocks?']())) {
              _slim_controls2['$<<'](item.$content())};
            return _slim_controls2['$<<']("</li>");}, $$128.$$s = self, $$128.$$arity = 1, $$128));
          _slim_controls2['$<<']("</ul>");
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$127.$$s = self, $$127.$$arity = 0, $$127));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$126.$$s = self, $$126.$$arity = 0, $$126));
    }, $Converter_ulist$125.$$arity = -2);
    
    Opal.def(self, '$page_break', $Converter_page_break$129 = function $$page_break(node, opts) {
      var $$130, self = this;
    ...
    }, $Converter_page_break$129.$$arity = -2);
    ...
    Opal.def(self, '$preamble', $Converter_preamble$143 = function $$preamble(node, opts) {
      var $$144, self = this;
    ...
    }, $Converter_preamble$143.$$arity = -2);
    
    Opal.def(self, '$listing', $Converter_listing$145 = function $$listing(node, opts) {
      var $$146, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$146 = function(){var self = $$146.$$s || this, $a, $$147, $$148, _buf = nil, nowrap = nil, syntax_hl = nil, lang = nil, doc_attrs = nil, css_mode = nil, style = nil, $writer = nil, _slim_controls1 = nil;
        if (self.style == null) self.style = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.$id(), "class": ["listingblock", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs($send(self.attributes, 'reject', [], ($$147 = function(key, _){var self = $$147.$$s || this;
          ...
          return key['$==']("data-id");}, $$147.$$s = self, $$147.$$arity = 2, $$147))))], ($$148 = function(){var self = $$148.$$s || this, $b, _slim_controls2 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes1 = nil, _temple_html_attributeremover2 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _temple_html_attributeremover3 = nil, _slim_codeattributes4 = nil;
          if (self.style == null) self.style = nil;
          ...
          _slim_controls2['$<<']("</div>");
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$148.$$s = self, $$148.$$arity = 0, $$148));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$146.$$s = self, $$146.$$arity = 0, $$146));
    }, $Converter_listing$145.$$arity = -2);
    
    Opal.def(self, '$inline_anchor', $Converter_inline_anchor$149 = function $$inline_anchor(node, opts) {
      var $$150, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$150 = function(){var self = $$150.$$s || this, $a, $$151, $$152, _buf = nil, $case = nil, refid = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.type == null) self.type = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["a", $hash2(["href", "class"], {"href": self.target, "class": [self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()].$compact()}).$merge(self.$data_attrs(self.attributes))], ($$151 = function(){var self = $$151.$$s || this, $b, _slim_controls2 = nil;
          if (self.text == null) self.text = nil;
          if (self.document == null) self.document = nil;
          ...
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$151.$$s = self, $$151.$$arity = 0, $$151));
        _buf['$<<'](_slim_controls1);}
        ...
        _slim_controls3 = $send(self, 'html_tag', ["a", $hash2(["href", "class", "target", "data-preview-link"], {"href": self.target, "class": [self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()].$compact(), "target": self.$attr("window"), "data-preview-link": self.$bool_data_attr("preview")}).$merge(self.$data_attrs(self.attributes))], ($$152 = function(){var self = $$152.$$s || this, _slim_controls4 = nil;
          if (self.text == null) self.text = nil;

        
          _slim_controls4 = [];
          _slim_controls4['$<<'](self.text);
          return (_slim_controls4 = _slim_controls4.$join(""));}, $$152.$$s = self, $$152.$$arity = 0, $$152));
        _buf['$<<'](_slim_controls3);};
        return (_buf = _buf.$join(""));}, $$150.$$s = self, $$150.$$arity = 0, $$150));
    }, $Converter_inline_anchor$149.$$arity = -2);
    
    Opal.def(self, '$section', $Converter_section$153 = function $$section(node, opts) {
      var $$154, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$154 = function(){var self = $$154.$$s || this, $a, $b, $$155, $$156, $$158, $$160, $$162, _buf = nil, titleless = nil, title = nil, hide_title = nil, vertical_slides = nil, data_background_image = nil, data_background_size = nil, data_background_repeat = nil, data_background_position = nil, data_background_transition = nil, section_images = nil, bg_image = nil, data_background_video = nil, data_background_color = nil, parent_section_with_vertical_slides = nil, _slim_htag_filter1 = nil;
        ...
        vertical_slides = $send(self, 'find_by', [$hash2(["context"], {"context": "section"})], ($$155 = function(section){var self = $$155.$$s || this;
          ...
          return section.$level()['$=='](2);}, $$155.$$s = self, $$155.$$arity = 1, $$155));
        ...
        section_images = $send(self.$blocks(), 'map', [], ($$156 = function(block){var self = $$156.$$s || this, $c, $$157, ctx = nil;
          ...
          if ((ctx = block.$context())['$==']("image")) {
            ...
            return ($truthy($c = $send(block, 'find_by', [$hash2(["context"], {"context": "image"})], ($$157 = function(image){var self = $$157.$$s || this;
              ...
              return ["background", "canvas"]['$include?'](image.$attributes()['$[]'](1));}, $$157.$$s = self, $$157.$$arity = 1, $$157))) ? $c : [])
        ...
        $send(self, 'content_for', ["footnotes"], ($$158 = function(){var self = $$158.$$s || this, $c, $d, $$159, slide_footnotes = nil;
          ...
          if ($truthy(($truthy($c = ($truthy($d = self.$document()['$footnotes?']()) ? self.$parent()['$attr?']("nofootnotes")['$!']() : $d)) ? slide_footnotes['$empty?']()['$!']() : $c))) {
            ...
            $send(slide_footnotes, 'each', [], ($$159 = function(footnote){var self = $$159.$$s || this;
              ...
              return _buf['$<<']("</div>");}, $$159.$$s = self, $$159.$$arity = 1, $$159));
            return _buf['$<<']("</div>");
          } else {
            return nil
          };}, $$158.$$s = self, $$158.$$arity = 0, $$158));
        $send(self, 'content_for', ["section"], ($$160 = function(){var self = $$160.$$s || this, $c, $$161, _slim_codeattributes1 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil, _slim_codeattributes5 = nil, _slim_codeattributes6 = nil, _slim_codeattributes7 = nil, _slim_codeattributes8 = nil, _slim_codeattributes9 = nil, _slim_codeattributes10 = nil, _slim_codeattributes11 = nil, _slim_codeattributes12 = nil, _slim_codeattributes13 = nil, _slim_codeattributes14 = nil, _slim_codeattributes15 = nil, _slim_codeattributes16 = nil, _slim_codeattributes17 = nil, _slim_codeattributes18 = nil, _slim_codeattributes19 = nil, _slim_codeattributes20 = nil, _slim_codeattributes21 = nil, _slim_codeattributes22 = nil, _slim_codeattributes23 = nil, _blocks = nil, _content = nil;
          ...
          if ($truthy(parent_section_with_vertical_slides)) {
            ...
            if ($truthy((_blocks = $rb_minus(self.$blocks(), vertical_slides))['$empty?']())) {
              ...
              $send(_blocks, 'each', [], ($$161 = function(block){var self = $$161.$$s || this;
                ...
                return _buf['$<<'](block.$convert());}, $$161.$$s = self, $$161.$$arity = 1, $$161));
              _buf['$<<']("</div>");
            };
          ...
          return _buf['$<<']("</section>");}, $$160.$$s = self, $$160.$$arity = 0, $$160));
        if ($truthy(parent_section_with_vertical_slides)) {
          
          _buf['$<<']("<section>");
          self.$yield_content("section");
          $send(vertical_slides, 'each', [], ($$162 = function(subsection){var self = $$162.$$s || this;
            ...
            return _buf['$<<'](subsection.$convert());}, $$162.$$s = self, $$162.$$arity = 1, $$162));
          _buf['$<<']("</section>");
    ...
    }, $Converter_section$153.$$arity = -2);
    
    Opal.def(self, '$open', $Converter_open$163 = function $$open(node, opts) {
      var $$164, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$164 = function(){var self = $$164.$$s || this, $a, $$165, $b, $c, $$166, _buf = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.style == null) self.style = nil;
        ...
        if (self.style['$==']("abstract")) {
          if ($truthy((($a = self.parent['$=='](self.document)) ? self.document.$doctype()['$==']("book") : self.parent['$=='](self.document)))) {
            ...
            _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["quoteblock", "abstract", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
              ...
              return nil
            }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$165 = function(){var self = $$165.$$s || this, _slim_controls2 = nil;
              ...
              _slim_controls2['$<<'](self.$content());
              _slim_controls2['$<<']("</blockquote>");
              return (_slim_controls2 = _slim_controls2.$join(""));}, $$165.$$s = self, $$165.$$arity = 0, $$165));
            _buf['$<<'](_slim_controls1);
          }
          ...
          _slim_controls3 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["openblock", (function() {if ($truthy(self.style['$!=']("open"))) {
            ...
            return nil
          }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$166 = function(){var self = $$166.$$s || this, _slim_controls4 = nil;
            ...
            _slim_controls4['$<<']("</div>");
            return (_slim_controls4 = _slim_controls4.$join(""));}, $$166.$$s = self, $$166.$$arity = 0, $$166));
          _buf['$<<'](_slim_controls3);
        };
        return (_buf = _buf.$join(""));}, $$164.$$s = self, $$164.$$arity = 0, $$164));
    }, $Converter_open$163.$$arity = -2);
    
    Opal.def(self, '$inline_footnote', $Converter_inline_footnote$167 = function $$inline_footnote(node, opts) {
      var $$168, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$168 = function(){var self = $$168.$$s || this, $$169, $$170, _buf = nil, footnote = nil, index = nil, id = nil, _slim_controls1 = nil, _slim_controls3 = nil;
        if (self.type == null) self.type = nil;
        ...
        if (self.type['$==']("xref")) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["sup", $hash2(["class"], {"class": ["footnoteref"]}).$merge(self.$data_attrs(footnote.$attributes()))], ($$169 = function(){var self = $$169.$$s || this, _slim_controls2 = nil;
          ...
          _slim_controls3 = $send(self, 'html_tag', ["sup", $hash2(["id", "class"], {"id": (function() {if ($truthy(id)) {
            ...
            return nil
          }; return nil; })(), "class": ["footnote"]}).$merge(self.$data_attrs(footnote.$attributes()))], ($$170 = function(){var self = $$170.$$s || this, _slim_controls4 = nil;
    ...
    }, $Converter_inline_footnote$167.$$arity = -2);
    
    Opal.def(self, '$image', $Converter_image$171 = function $$image(node, opts) {
      var $$172, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$172 = function(){var self = $$172.$$s || this, $a, $$173, _buf = nil, inline_style = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        if ($truthy(($truthy($a = self.$attributes()['$[]'](1)['$==']("background")) ? $a : self.$attributes()['$[]'](1)['$==']("canvas")))) {
          ...
          _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class", "style"], {"id": self.id, "class": ["imageblock", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
            ...
            return nil
          }; return nil; })()], "style": inline_style}).$merge(self.$data_attrs(self.attributes))], ($$173 = function(){var self = $$173.$$s || this, _slim_controls2 = nil;
    ...
    }, $Converter_image$171.$$arity = -2);
    
    Opal.def(self, '$title_slide', $Converter_title_slide$174 = function $$title_slide(node, opts) {
      var $$175, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$175 = function(){var self = $$175.$$s || this, $a, _buf = nil, bg_image = nil, bg_video = nil, _temple_html_attributeremover1 = nil, _temple_html_attributemerger1 = nil, $writer = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil, _slim_codeattributes4 = nil, _slim_codeattributes5 = nil, _slim_codeattributes6 = nil, _slim_codeattributes7 = nil, _slim_codeattributes8 = nil, _slim_codeattributes9 = nil, _slim_codeattributes10 = nil, _slim_codeattributes11 = nil, _slim_codeattributes12 = nil, _slim_codeattributes13 = nil, _slim_codeattributes14 = nil, _slim_codeattributes15 = nil, _title_obj = nil, _slice = nil, preamble = nil;
        if (self.header == null) self.header = nil;
        if (self.document == null) self.document = nil;
    ...
    }, $Converter_title_slide$174.$$arity = -2);
    
    Opal.def(self, '$paragraph', $Converter_paragraph$176 = function $$paragraph(node, opts) {
      var $$177, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$177 = function(){var self = $$177.$$s || this, $a, $$178, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["paragraph", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$178 = function(){var self = $$178.$$s || this, _slim_controls2 = nil;
          ...
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$178.$$s = self, $$178.$$arity = 0, $$178));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$177.$$s = self, $$177.$$arity = 0, $$177));
    }, $Converter_paragraph$176.$$arity = -2);
    
    Opal.def(self, '$floating_title', $Converter_floating_title$179 = function $$floating_title(node, opts) {
      var $$180, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$180 = function(){var self = $$180.$$s || this, _buf = nil, _slim_htag_filter1 = nil, _slim_codeattributes1 = nil, _temple_html_attributeremover1 = nil, _slim_codeattributes2 = nil;
    ...
    }, $Converter_floating_title$179.$$arity = -2);
    
    Opal.def(self, '$inline_callout', $Converter_inline_callout$181 = function $$inline_callout(node, opts) {
      var $$182, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$182 = function(){var self = $$182.$$s || this, _buf = nil, _slim_codeattributes1 = nil, _slim_codeattributes2 = nil, _slim_codeattributes3 = nil;
        if (self.document == null) self.document = nil;
        if (self.text == null) self.text = nil;
        ...
        return (_buf = _buf.$join(""));}, $$182.$$s = self, $$182.$$arity = 0, $$182));
    }, $Converter_inline_callout$181.$$arity = -2);
    
    Opal.def(self, '$inline_image', $Converter_inline_image$183 = function $$inline_image(node, opts) {
      var $$184, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$184 = function(){var self = $$184.$$s || this, $a, $$185, _buf = nil, _slim_controls1 = nil;
        if (self.type == null) self.type = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["span", $hash2(["class", "style"], {"class": [self.type, self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()}).$merge(self.$data_attrs(self.attributes))], ($$185 = function(){var self = $$185.$$s || this, _slim_controls2 = nil;

        
          _slim_controls2 = [];
          _slim_controls2['$<<'](self.$convert_inline_image());
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$185.$$s = self, $$185.$$arity = 0, $$185));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$184.$$s = self, $$184.$$arity = 0, $$184));
    }, $Converter_inline_image$183.$$arity = -2);
    
    Opal.def(self, '$inline_quoted', $Converter_inline_quoted$186 = function $$inline_quoted(node, opts) {
      var $$187, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$187 = function(){var self = $$187.$$s || this, $a, $b, _buf = nil, quote_tags = nil, quote_tag = nil, $case = nil, open = nil, close = nil;
        if (self.type == null) self.type = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        if (self.text == null) self.text = nil;
        ...
        return (_buf = _buf.$join(""));}, $$187.$$s = self, $$187.$$arity = 0, $$187));
    }, $Converter_inline_quoted$186.$$arity = -2);
    
    Opal.def(self, '$example', $Converter_example$188 = function $$example(node, opts) {
      var $$189, self = this;
      ...
      node.$extend($$($nesting, 'Helpers'));
      return $send(node, 'instance_eval', [], ($$189 = function(){var self = $$189.$$s || this, $a, $$190, _buf = nil, _slim_controls1 = nil;
        if (self.id == null) self.id = nil;
        if (self.attributes == null) self.attributes = nil;
        ...
        _slim_controls1 = $send(self, 'html_tag', ["div", $hash2(["id", "class"], {"id": self.id, "class": ["exampleblock", self.$role(), (function() {if ($truthy(($truthy($a = self['$option?']("step")) ? $a : self['$attr?']("step")))) {
          ...
          return nil
        }; return nil; })()]}).$merge(self.$data_attrs(self.attributes))], ($$190 = function(){var self = $$190.$$s || this, _slim_controls2 = nil;
          ...
          _slim_controls2['$<<'](self.$content());
          _slim_controls2['$<<']("</div>");
          return (_slim_controls2 = _slim_controls2.$join(""));}, $$190.$$s = self, $$190.$$arity = 0, $$190));
        _buf['$<<'](_slim_controls1);
        return (_buf = _buf.$join(""));}, $$189.$$s = self, $$189.$$arity = 0, $$189));
    }, $Converter_example$188.$$arity = -2);
    return (Opal.def(self, '$set_local_variables', $Converter_set_local_variables$191 = function $$set_local_variables(binding, vars) {
      var $$192, self = this;

      return $send(vars, 'each', [], ($$192 = function(key, val){var self = $$192.$$s || this;
        ...
        return binding.$local_variable_set(key.$to_sym(), val);}, $$192.$$s = self, $$192.$$arity = 2, $$192))
    }, $Converter_set_local_variables$191.$$arity = 2), nil) && 'set_local_variables';
...
Opal.modules["asciidoctor-revealjs/version"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $parent_nesting) {
      ...
      Opal.const_set($nesting[0], 'VERSION', "5.0.1")
    })($nesting[0], $nesting)
  })($nesting[0], $nesting)
};
